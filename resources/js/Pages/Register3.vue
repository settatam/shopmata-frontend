    ...
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 lg:w-1/2">
      <div class="mx-auto w-full">
        ...
        <div class="mt-8">
          ...
          <div class="mt-6">
            <form action="#" method="POST" class="space-y-6" v-on:submit.prevent="registerUser">
              <div>
                <label for="store_name" class="block text-sm font-medium text-gray-700">
                  Store Name
                </label>
                <div class="mt-1 relative rounded-md shadow-sm">
                  <input id="store_name" name="store_name" type="text" autocomplete="store_name" required="" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" v-model="user.store_name"/>
              ...
              <div class="flex">
                <div class="lg:w-1/2 md:w-1/2">
                  ...
                  <div class="mt-1 relative rounded-md shadow-sm mr-4">
                    <input id="first_name" name="first_name" type="text" autocomplete="first_name" required="" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" v-model="user.first_name"/>
                  </div>
                </div>
                <div class="lg:w-1/2 md:w-1/2">
                  ...
                  <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="last_name" name="last_name" type="text" autocomplete="last_name" required="" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" v-model="user.last_name"/>
                  </div>
                </div>
              </div>
