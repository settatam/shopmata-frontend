...
export default {
    ...
    setup(props) {
        ...
        let name = ref(null !==  props.transaction.payment_address ?   props.transaction.payment_address.payment_type.name : null);
        ...
        return { isEdit, name, toggleEdit, payment_method, checkPaymentMethod };
    },
};
</script>
