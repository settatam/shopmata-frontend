    ...
    <app-layout>
        <div class="flex-1 flex flex-col mt-4 min-h-screen">
            ...
            <nav class="flex px-4 md:px-8 mb-4" aria-label="Breadcrumb">
                <ol
                    role="list"
                    class="flex items-center space-x-4 font-bold text-2xl"
                >
                    <li>
                        <div>
                            <a href="/orders" class="">
                ...
                <div class="flex flex-col w-full md:w-2/3 mr-5 gap-4">
                    <div class="bg-white py-4 md:py-6 px-5 md:px-8 rounded">
                        ...
                        <p class="mt-2.5 text-xs md:text-base">
                            ...
                            {{ parseFloat(order.total_orders).toFixed(2) }} from
                            Online Store
                        </p>
                        <div
                        ...
                        >
                            <div
                                class="w-full flex md:w-4.5/10 justify-between"
                            >
                                <div class="flex">
                                    <img
                                ...
                                <div class="">
                                    <p class="text-xm md:text-base mb-1">
                                        Promotion
                                    </p>
                        ...
                        <div>
                            ...
                            <div class="flex justify-between">
                                ...
                                >
                                    {{ store.currency.symbol_left }}
                                    {{
                                        parseFloat(order.sales_tax).toFixed(
                                            2
                                        ) || "0.00"
                                    }}
                                </p>
                    ...
                    <div class="bg-white py-4 md:py-6 px-5 md:px-8 rounded">
                                ...
                                <div>
                                    ...
                                    <span
                                        :class="[
                                            ...
                                            'text-xs pl-5 pr-8  py-1 rounded capitalize',
                                        ]"
                                        >{{ order.status }}</span
                                    >
                                </div>
                        ...
                        <div
                            class="mt-3.5 border-t border-gray-100 -mx-6"
                        ></div>
                        <div class="mt-5">
                            ...
                            >
                                <div class="flex items-center w-2/5 md:w-1/5">
                                    <h2
                                        class="font-normal text-xm md:text-base"
                                    >
                                        Order Status
                                    </h2>
                                </div>
                                    ...
                                    <button
                                        :class="[
                                            order_status == ''
                                                ? 'bg-indigo-400'
                                                : 'bg-indigo-700',
                                            'p-2 border text-white rounded-md',
                                        ]"
                                        :disabled="order_status == ''"
                                        @click="updateStatus"
                                    >
                                        Update Status
                                    </button>
                        ...
                        <div class="flex mb-2">
                            <h2 class="font-normal text-xm md:text-xs">
                                Customer Note
                            </h2>
                        </div>
                    ...
                    <div class="flex flex-col w-full md:hidden">
                        ...
                        <div class="bg-white pl-5 pr-7 pb-10 pt-6 mb-5 rounded">
                            ...
                            <div class="flex justify-between mb-4">
                                <h2 class="font-bold">Tax Settings</h2>
                                <a
                                    href="/order/manage"
                                    class="
                                        text-indigo-700
                        ...
                        >
                            ...
                            <div>
                                <input
                                    ...
                                    id=""
                                    class="mr-2"
                                    v-model="show_timeline"
                                />
                                <label for="timeline" class="text-xs"
                                    >Show comments</label
                                >
                            </div>
                        </div>
                        ...
                        <div class="timeline_container" v-if="show_timeline">
                            ...
                            >
                                <div class="date text-gray-500">
                                    {{ moment(timeline.date).format("ll") }}
                                </div>
                                <div class="flex justify-between">
                                    <div>
                                    ...
                                    <div class="date text-gray-500">
                                        {{ moment(timeline.date).format("LT") }}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="hidden md:flex flex-col w-full md:w-1/3">
                    <div class="bg-white pl-5 mb-3 pr-7 pb-6 pt-6 rounded">
                        ...
                        <div>
                            <div class="mb-2 flex justify-between">
                                <div>
                                    <h2 class="text-gray-700">Channel:</h2>
                                </div>
                                <div>
                            ...
                            <div class="mb-2 flex justify-between">
                                <h2 class="text-gray-700">Date:</h2>
                                <div>
                                    <h2 class="text-gray-800">
                                        {{
                                            moment(order.updated_at).format(
                            ...
                            <div class="mb-2 flex justify-between">
                                <h2 class="text-gray-700">Payment Method</h2>
                                <div>
                                    <h2 class="text-gray-800">
                                        {{
                            ...
                            <div class="flex justify-between">
                                <h2 class="text-gray-700">Delivery</h2>
                                <div>
                                    <h2 class="text-gray-800">
                                        {{
                                            order.delivery ||
