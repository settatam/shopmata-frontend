      ...
      >
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            ...
            <div
              class="bg-white border-t-2 border-gray-200 py-4 product-list"
              v-if="products.length !== 0"
            >
              <div
                class="grid grid-cols-8 gap-2 py-2"
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          ...
          <div class="loading p-2" v-if="loading">
...
export default {
  ...
  methods: {
    ...
    addProduct(product) {
      const ifProduct = this.selectedProducts.filter(
      ...
      ifProduct.length > 0
        ...
        : this.selectedProducts.push({ ...product, quantityOrdered: 1 });
    },
    addOrder() {
