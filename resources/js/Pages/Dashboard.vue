<template>
    ...
    <div class="flex-grow w-full mx-auto xl:px-8 lg:flex">
      ...
      <div class="flex-1 min-w-0 xl:flex flex-col pr-5">
        ...
        <div>
            <h1 class="text-2xl leading-6 font-medium text-gray-900 my-5">Overview</h1>
                ...
                <div class="p-5">
                  <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                      <dl>
                        <dt class="text-xs font-medium text-gray-500 truncate uppercase tracking-wide">
                          {{ card.name }}
                        </dt>
                        <dd>
        ...
        <div class="lg:min-w-0 lg:flex-1 mb-5">
          <div class="shadow bg-white overflow-hidden sm:rounded-md mt-5">
            <ul role="list bg-white" class="divide-y divide-gray-200">
              <li v-for="notification in notifications" :key="notification.title">
                <inertia-link :href="notification.link" class="block hover:bg-gray-50">
...
const cards = [
  ...
  { name: 'Total Customers', href: '#', icon: ScaleIcon, amount: '$30,659.45' },
  // More items...
]
