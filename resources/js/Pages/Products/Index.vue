    ...
    <app-layout>
        ...
        <div class="">
            <div class="px-4 sm:px-6 lg:mx-auto lg:px-8">
                <div
                    class="py-6 flex items-center md:justify-between lg:border-t lg:border-gray-200"
                >
                    <div class="flex-1 min-w-0">
                        <!-- Profile -->
                        <div class="flex items-center">
                            <h1
                                class="ml-3 text-lg md:text-2xl font-semibold leading-7 text-gray-900 sm:leading-9 sm:truncate"
                            >
                                All Products
                            </h1>
                        </div>
                  ...
                  <trash-icon class="w-4 h-4  text-red-500"/>
                        ...
                        >
                            <plus-icon
                                class="md:w-5 md:h-5 w-4 h-4 text-white mr-2"
                            />
                            Create New Product
                        </inertia-link>
                    </div>
            ...
            <div class="sm:block">
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="border-b-2 div-mb border-gray-200 w-full"></div>
                        ...
                        <div
                            class="grid grid-cols-2 gap-2 md:px-0 md:grid-cols-4 rounded bg-transparent"
                        >
                            <div class="">
                                <label
                                    for="search-field"
                                    class="text-xm md:text-base"
                                    >Search</label
                                >
                                <div
                            ...
                            <div class="">
                                <label for="brand" class="text-xm md:text-base"
                                    >Brand</label
                                >
                                <select
                                    name="brand"
                            ...
                            <div class="flex flex-col">
                                <label for="Status" class="text-xm md:text-base"
                                    >Product Type</label
                                >
                                <select
                                    name="Status"
                            ...
                            <div class="flex flex-col">
                                <label for="Tag" class="text-xm md:text-base"
                                    >Status</label
                                >
                                <div class="flex">
                                    <select
                                    ...
                                    <div
                                        class="border hidden md:block p-3 cursor-pointer rounded border-red-500 ml-1"
                        ...
                        <div
                            class="flex items-center justify-between my-4 md:hidden"
                        >
                            <div
                    ...
                    <div class="hidden md:flex flex-col mt-2 md:mt-6">
                        ...
                        >
                            ...
                            >
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th
                                            scope="col"
                                            class="w-2/5 max-w-0 px-6 py-3 text-left text-xs font-normal text-gray-500 uppercase tracking-wider"
                                        >
                                            <input
                                                id="comments"
                                                aria-describedby="comments-description"
                                        ...
                                        <th
                                            scope="col"
                                            class="w-2/10 px-6 py-3 text-left text-xs font-normal text-gray-500 uppercase tracking-wider"
                                        >
                                            STOCK LEVEL
                                        </th>
                                        <th
                                            scope="col"
                                            class="w-1/10 px-6 py-3 text-left text-xs font-normal text-gray-500 uppercase tracking-wider"
                                        >
                                            BRAND
                                        </th>
                                        <!--                                        <th-->
                          ...
                          <span class="sr-only">Edit</span>
                                ...
                                >
                                    <tr
                                        v-for="product in productListing"
                                        :key="product.id"
                                        class="bg-white hover:bg-indigo-50"
                                    >
                                        <td
                                            class="w-2/5 max-w-0 px-6 py-4 items-center text-gray-900"
                                        >
                                            <div class="flex items-center">
                                                ...
                                                <div
                                                    class="flex-shrink-0 h-12 w-12 mr-5"
                                                >
                                                    <img
                                                        v-if="
                                                            product.images
                                        ...
                                        <td
                                            class="w-2/10 px-6 py-4whitespace-nowrap text-sm text-gray-500"
                                        >
                                            <!--                                            <span-->
                                        ...
                                        <td
                                            class="w-1/10px-6 py-4 whitespace-nowrap text-sm text-gray-500"
                                        >
                                            <span
                                                class="text-gray-900 font-normal"
                                                >{{
                                        ...
                                        <td
                                            class="w-1/10 px-6 py-4 whitespace-nowrap text-sm text-gray-500 md:block"
                                        >
                                            <span
                                                :class="[
                                                    statusStyles[
                                                    ...
                                                    'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-normal capitalize',
                                                ]"
                                            >
                                                {{ product.status }}
                                            </span>
                                        ...
                                        <!--                                        <td-->
                                        <!--                                            class="w-1/10 px-6 py-4 text-right whitespace-nowrap text-sm text-gray-500"-->
                                        <!--                                        >-->
                                        <!--                                            <time-->
                    ...
                    <div
                        class="md:hidden flex flex-col items-center pb-20 mt-3 rounded bg-white"
                        v-if="products.data.length == 0"
                    >
                        <img
                            src="../../../assets/EmptyTable.svg"
                    ...
                    <div
                        class="flex flex-col md:hidden mt-3 p-4 bg-white rounded"
                        v-else
                    >
                        <div
                            class="flex flex-col"
                        ...
                        >
                            <div class="flex justify-between">
                                <div class="flex items-center w-4/5 mr-1">
                                    <input
                                        ...
                                        name="comments"
                                        type="checkbox"
                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded cursor-pointer mr-1"
                                        :value="product.id"
                                        v-model="selected"
                                        @click="uncheckBox(product.id)"
                                    />
                                    ...
                                    <div
                                        class="flex flex-col w-full overflow-x-hidden"
                                    >
                                        <div>
                                            <inertia-link
                                                :href="
                                            ...
                                            >
                                                <p
                                                    class="text-gray-800 truncate group-hover:text-gray-900 text-xm break-normal"
                                                >
                                                    {{ product.title }}
                                                </p>
                                            </inertia-link>
                                        ...
                                        <div>
                                            <span
                                                class="text-green-700 bg-green-100 py-0.5 px-2.5 text-xxs font-normal"
                                            >
                                                Active
                                            </span>
                                        </div>
                                        <div>
                                            <span
                                                class="text-gray-900 font-normal text-xm"
                                                >1 in Stock</span
                                            >
                                        </div>
                                    </div>
                            ...
                            <div
                                class="border-t border-gray-100 -mx-4 my-2"
                            ></div>
                        </div>
                    </div>
                    <delete-alert
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    <a
                                        href="#"
                                        class="relative inline-flex items-center px-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
                                    >
                                    ...
                                    <a
                                        href="#"
                                        aria-current="page"
                                        class="z-10 bg-indigo-500 rounded text-white relative inline-flex items-center px-2"
                                    >
                                        1
                                    </a>
                                    <a
                                        href="#"
                                        class="text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-2"
                                    >
                                        2
                                    </a>
                                    <a
                                        href="#"
                                        class="text-gray-500 hover:bg-gray-50 hidden md:inline-flex relative items-center px-2"
                                    >
                                        3
                                    </a>
                                    <span
                                        class="relative inline-flex items-center px-2 text-gray-700"
                                    >
                                        ...
                                    </span>
                                    <a
                                    ...
                                    <a
                                        href="#"
                                        class="relative inline-flex items-center px-2 rounded-r-md font-medium text-gray-700 hover:bg-gray-50"
                                    >
...
export default {
    ...
    methods: {
        ...
        uncheckBox(id) {
            ...
            this.products.data.length == this.selected.length
