            ...
            >
                ...
                >
                    <div class="w-auto  lg:ml-7 lg:mr-2">
                        <div
                            class="p-4 md:p-8 pb-20 bg-white rounded-md mb-6 w-max md:w-full"
                        >
                            <div>
                            ...
                            <div class="flex justify-between">
                                ...
                                <button
                                    type="button"
                                    class="rounded-md border border-transparent shadow-sm px-10 py-3 bg-indigo-600 text-base disabled:bg-gray-400 font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
                                    :disabled="loading"
                                    @click="submit"
                                >
                                    <i
    ...
    setup ({ store, remittance }, { emit }) {
        ...
        const submit = () => {
            ...
            if (!payment.routing_number.length && store.country_id == 1) {
                ...
                axios
                    .patch(`/settings/remittance/${remittance.id}`, payment)
                    .then(res => {
                        if (res.status == 200) {
