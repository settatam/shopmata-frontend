              ...
              <div class="w-full xl:w-9.5/10 xl:ml-7">
                <div class="p-4 md:p-8 bg-white">
                  ...
                  <success v-if="success" :msg="successMessage" class="sticky top-20 w-full z-30"/>
                    ...
                    <button class="text-white rounded-md px-8 py-3 float-right my-5" :class="loading ? 'bg-gray-400' : 'bg-indigo-600' " @click="submit" :disabled='gift.expire==2 && !gift.period || loading' >
