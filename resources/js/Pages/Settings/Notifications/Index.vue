                    ...
                    <div class="w-auto lg:ml-7 lg:mr-2">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-500 mb-4">
                                Choose which notifications you want to get for
                                this site.
                            </p>
                            <div class="p-4 lg:p-8 mb-6 bg-white">
                                ...
                                <div v-if="openOrder">
                                    <div
                                        v-for="order in notifications.orders"
                                        :key="order.id"
                                    ...
                                    >
                                        ...
                                        <p
                                            class="text-gray-500 w-full md:w-7/10"
                                        >
                                            {{ order.description }}
                                        </p>
                                    </div>
                            ...
                            <div class="p-4 md:p-8 my-6 bg-white">
                                ...
                                <div v-if="openLocal">
                                    ...
                                    >
                                        ...
                                        >
                                            <p
                                                class="font-bold text-indigo-700 no-underline"
                                            >
                                                {{ delivery.name }}
                                            </p>
                                        </inertia-link>
                            ...
                            <div class="p-4 md:p-8 my-6 bg-white">
                                ...
                                >
                                    ...
                                    <chevron-up-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        v-if="openShipping"
                                        @click="openShipping = false"
                                    />
                                    <chevron-down-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        v-else
                                        @click="openShipping = true"
                                    />
                                </div>
                                <div v-if="openShipping">
                                    <div
                                        v-for="shipping in notifications.shippings"
                                        :key="shipping.id"
                                        class="flex flex-col md:flex-row mb-5"
                                    >
                                        <inertia-link
                                            :href="`/settings/notifications/${shipping.id}`"
                                            class="w-full md:w-3/10"
                                        >
                                            <p
                                                class="font-bold text-indigo-700 no-underline cursor-pointer"
                            ...
                            <div class="p-4 md:p-8 my-6 bg-white">
                                ...
                                >
                                    ...
                                    <chevron-down-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        v-if="openPickup == false"
                                        @click="openPickup = true"
                                    />
                                </div>
                                <div v-if="openPickup">
                                    <div
                                        v-for="pickup in notifications.pickups"
                                        :key="pickup.id"
                                        class="flex flex-col md:flex-row mb-5"
                                    >
                                        <inertia-link
                            ...
                            <div class="p-4 md:p-8 my-6 bg-white">
                                ...
                                >
                                    ...
                                    <chevron-up-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        v-if="openCustomer"
                                        @click="openCustomer = false"
                                    />
                                    <chevron-down-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        v-else
                                        @click="openCustomer = true"
                                    />
                                </div>
                                <div v-if="openCustomer">
                                    <div
                                        v-for="customer in notifications.customers"
                                        :key="customer.id"
                                        class="flex flex-col md:flex-row mb-5"
                                    >
                                        <inertia-link
                            ...
                            <div class="p-4 md:p-8 my-6 bg-white">
                                ...
                                >
                                    ...
                                    <chevron-up-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        @click="openMarketing = false"
                                        v-if="openMarketing"
                                    />
                                    <chevron-down-icon
                                        class="w-6 h-6 text-indigo-700 cursor-pointer"
                                        @click="openMarketing = true"
                                        v-else
                                    />
                                </div>
                                <div v-if="openMarketing">
                                    <div
                                        v-for="email in notifications.marketings"
                                        :key="email.id"
                                        class="flex flex-col md:flex-row mb-5"
                                    >
                                        <inertia-link
                                            :href="`/settings/notifications/${email.id}`"
                                            class="w-full md:w-3/10"
                                        >
                                            <p
                                                class="font-bold text-indigo-700 no-underline cursor-pointer"
                            ...
                            <div class="p-4 md:p-8 my-6 bg-white">
                                ...
                                <div v-if="openReturn">
                                    <div
                                        v-for="(
                                            ret, index
                                        ) in notifications.returns"
                                        :key="index"
                                        class="flex flex-col md:flex-row mb-5"
                                    >
                                        <inertia-link
                                            :href="`/settings/notifications/${ret.id}`"
                                            class="w-full md:w-3/10"
                                        >
                                            <p
                                                class="font-bold text-indigo-700 no-underline cursor-pointer"
