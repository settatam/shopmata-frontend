                        ...
                        <div class="mb-6">
                            ...
                            <div class="px-4 lg:px-8 py-6 mb-6 bg-white">
                                ...
                                >
                                    ...
                                    <p class="text-gray-500">
                                        Choose where you ship and how much you
                                        charge for shipping at checkout. Learn
                                        more
                                        <a
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <p
                                                class="font-semibold uppercase mr-8"
                                            >
                                                Custom Shipping Rate
                                            </p>
                                            <p
                                                class="px-2 bg-gray-200 text-gray-400"
                                            >
                                                Default
                                            </p>
                                        </div>
                                    ...
                                    <span class="mt-2 mb-10 text-gray-500">
                                        Create a shipping profile to add custom
                                                    ...
                                                    <table class="min-w-full">
                                                        <thead class="border-b">
                                                            <tr>
                                                                ...
                                                                <th
                                                                    scope="col"
                                                                    class="text-sm font-medium text-gray-600 px-6 py-4 text-left"
                                                                >
                                                                    Domestic
                                                                </th>
                                                                <th
                                ...
                                <div class="rounded-sm flex flex-col">
                                    <div class="flex">
                                        <input
                                            type="checkbox"
                                            id=""
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded mr-2.5 mt-1"
                                            v-model="local_delivery"
                                        />
                                        <div
                                    ...
                                    <div
                                        class="flex flex-col items-start mb-6 ml-6"
                                    >
                                        <span class="text-gray-500"
                                            >Allow local customers to pick up
