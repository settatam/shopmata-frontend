            ...
            <div>
              ...
              <div class="mt-3 sm:mt-5">
                <div class=" required w-full mb-4">
                    ...
                    <input type="text"  class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" v-model="local_pickup.location_name" required/>
                  </div>
