                ...
                <div class="w-2/3 mt-5 bg-white card">
                    <div class="p-8">
                        <div class="flex justify-between">
                            <h1 class="text-2xl font-semibold mb-4.5">
                                Menu Lists
                            </h1>
                            <div class="text-indigo-600 cursor-pointer">
                                <p
                                    @click="addMenu"
                                    class="underline flex cursor-pointer"
                                >
                                    <span class="pl-3"
                        ...
                        <p>
                            In this section, you can create your menu and adjust
                            your menu settings to reflect your design, tap the
                            button below to begin. You can ( Create menu) or
                            Edit menu
                        </p>
