    ...
    <app-layout>
        ...
        <div class="flex justify-between items-center mx-8 mt-8">
            <a href="/online-store/navigation/" class="hover:text-gray-700">
                <div class="flex items-center">
                    <ArrowLeftIcon
                        class="flex-shrink-0 h-5 w-5 text-gray-800"
                        aria-hidden="true"
                    />
                    <h1 class="ml-4 text-xl font-extrabold text-gray-800">
                        {{ menu.name }}
                    </h1>
                </div>
            </a>
            <div class="">
                <button
                    class="text-white bg-indigo-700 rounded-sm px-5 py-2"
                    @click="addMenu"
                >
                    Add Menu Item
                </button>
                ...
                <div class="w-2/3 ml-7 mt-5">
                    ...
                    <div>
                        ...
                        <div class="w-full mb-4" v-else>
                            <p>
                                <span>You do not have any menu created.</span>
                                <inertia-link
                                    href="/online-store/navigation/create"
                                    >Create Menu List</inertia-link
                                >
                            </p>
                        </div>
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        pages.push({
            name: m.name,
            href: `/online-store/navigation/${m.name}`,
            current: true,
        });
