              ...
              <div class="w-2/3 ml-7 mt-5">
                ...
                <div>
                  <div class="w-full mb-4" v-if="menu.items.length">
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-sm p-6">
                      <h2 class="text-lg text-indigo-700 font-semibold mb-3.5">Menu Items</h2>
                        <ul role="list" class="">
                          <li v-for="m in menu.items" :key="m.id">
                          <div class="flex items-center justify-between mt-1 mb-2 p-2 bg-white border-2 overflow-hidden sm:rounded-sm">
