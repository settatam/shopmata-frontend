...
<!-- FONT AWESOME LINK -->
              ...
              <inertia-link href="#" class="-ml-1 inline-flex items-center space-x-3 text-sm font-medium text-blue-gray-900">
                ...
                <div class="bg-white my-8 px-10 pt-7 pb-10 ">
                    <div class="flex items-center mb-3">
                        <p class="font-semibold text-xl mr-7">Current Theme </p> <i class="far fa-question-circle"></i>
                    </div>
                    <p class="mb-5 text-gray-500">This is the theme customers see when they visit your store.</p>
                    <div class="flex flex-col lg:flex-row">
                        <img src="../../../assets/placeholder_theme.jpg" alt="placeholder theme"> 
                        <div class="flex flex-col ml-2 lg:ml-11">
                            <div class="flex mb-4 items-baseline">
                                <p class="font-semibold text-xl mr-5">Cornerstore Beam</p> <p class="text-gray-500">Includes 3 styles</p>
                            </div>
                            <p class="text-gray-500 mb-4">Showcase your brand and products with Cornerstone Beam, our signature theme</p>
    ...
    <div>
      <MenuButton class="inline-flex justify-center w-full border border-gray-300 shadow-sm px-6 py-4 bg-white text-sm font-medium text-gray-700 focus:outline-none">
        Actions
    ...
    <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
      <MenuItems class="origin-top-left absolute left-0 mt-2 w-44 lg:w-56 rounded-md shadow-lg bg-white focus:outline-none">
        <div class="py-1">
          ...
          <MenuItem v-slot="{ active }">
            <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Themes Details</a>
          </MenuItem>
          <MenuItem v-slot="{ active }">
            <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Download Themes</a>
          </MenuItem>
        </div>
      </MenuItems>
    </transition>
                ...
                <div class="bg-white px-10 pt-7 pb-8">
                    <p class="font-semibold text-xl mr-7">My Themes </p>
                    <p class="text-gray-500">Manage and store all your published themes. This includes the collections of your active and inactive themes.</p>
                    <div class="flex flex-col lg:flex-row">
                        <div>
                        <div class="flex flex-col border border-gray-300 lg:w-72 mt-7">
                            <img src="../../../assets/placeholder_theme2.jpg" alt="my theme placeholder">
                            <p class="mt-2 font-semibold pl-4">Cornerstore Beam</p>
                            <div class="flex flex-row justify-between items-center pl-4">
                            <p class="text-xs text-gray-500">Version 1.1.0</p>
