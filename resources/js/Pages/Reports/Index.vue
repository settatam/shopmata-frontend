    ...
    <app-layout :navigation="navigation">
        ...
        <div id="container" class="flex flex-col mx-3 space-y-1">
            <div class="mx-2 mt-3">
                ...
                <p @click="filterToggle" class="text-black  underline text-sm cursor-pointer font-bold">FILTER BY:</p>

                <Filter :to="to" :from="from" :stores="stores" class="mb-3" v-if="displayFilter"
                    @switchToggle="filterToggle" @getFilters="sendFilters" />
            </div>
