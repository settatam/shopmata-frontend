                            ...
                            <template v-for="item in navigation" :key="item.name">
                                <div v-if="!item.children">
                                    <inertia-link :href="item.href" :class="[
                                        ...
                                        <component :is="item.icon" class="
                                            ...
                                            h-6
                                            w-6
                                            text-cyan-200" aria-hidden="true" />
                                        {{ item.name }}
                                    </inertia-link>
                                </div>
                                <Disclosure as="div" v-else class="space-y-1" v-slot="{ open }">
                                    ...
                                    <DisclosurePanel class="space-y-1">
                                        <inertia-link v-for="subItem in item.children" :key="subItem.name"
                                            :href="subItem.href" class="
                                            group
                                            w-full
                                            flex
                                            items-center
                    ...
                    <div class="flex-1 flex">
                        <form class="w-full flex md:ml-0" @submit.prevent="doSearch">
                            ...
                            <div class="
                                ...
                                <input id="search-field" name="search-field" v-model="term" class="
                                        block
                                        w-full
                                        h-full
                                        pl-8
